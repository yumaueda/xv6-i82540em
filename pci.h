...
// CONFIG_ADDRESS
//----------------
#define BUS_NUM_MAX               256
#define DEV_NUM_MAX               32
#define FUNC_NUM_MAX              8
#define ENABLE_BIT_SHIFT          31
...
#define COMMAND                   0x00000004
#define REV_ID                    0x00000008
#define CACHE_LINE_SIZE           0x0000000c
#define BAR_START                 0x00000010
#define PRIM_BUS_NUM              0x00000018
#define BAR_END                   0x00000028
...
#define GET_DEVICE_ID(vdid)       ((vdid) & DEVICE_ID_MASK)

//---------
// Command
//---------
#define COMMAND_IO_ENABLE         0x00000001
#define COMMAND_MEM_ENABLE        0x00000002
#define COMMAND_MASTER_ENABLE     0x00000004
#define COMMAND_SPECIAL_ENABLE    0x00000008
#define COMMAND_INVALIDATE_ENABLE 0x00000010
